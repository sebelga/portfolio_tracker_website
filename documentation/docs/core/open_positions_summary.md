...
description: Learn about the Open Positions Summary sheet, which aggregates data for all your open investment positions in the TradeGist Add-on.
tags: [open positions, summary, portfolio-tracker, tradegist, google-sheets]
---
