...
| **Total cost b. curr.**  | The total cost converted to your base currency (e.g., EUR), including historical FX rates and wash sale adjustments. |
...
- **Wash Sale Impacts**: The **Total cost b. curr.** includes deferred losses from wash sales. If this value looks higher than your "Total Cost" in asset currency, it likely reflects a recently applied wash sale adjustment.
