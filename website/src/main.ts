...
(function init() {
  ...
  const showToastError = (message: string) => {
    ...
    // FIX: Native <dialog> elements exist in the browser's "Top Layer" which ignores standard z-index.
    // To render above a modal, we intelligently inject the toast directly into the open dialog if one exists.
